  ...
  return (
    <main className="flex min-h-screen items-center justify-center">
      ...
      <div className="bg-cover flex flex-col justify-center items-center w-1/2 min-h-screen relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center transition-opacity duration-300 ease-in-out opacity-100 hover:opacity-100 bg-gradient-to-br from-sky-200 via-rose-300 to-slate-600">
